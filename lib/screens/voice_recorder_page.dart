...
class _RecPageState extends State<RecPage>
  ...
  Future<void> openTheRecorder() async {
    ...
    _mRecorder?.setLogLevel(Level.nothing);
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () {
                                  String now = DateFormat('h_mm a - EEE, d MMM, yyyy')
                                      .format(DateTime.now());
                                  String title = recordingTitle.text.trim().isEmpty
                                      ? 'Recording_$now'
                            ...
                            child: SizedBox(
                              ...
                              child: ElevatedButton(
                                onPressed: () async {
                                  ...
                                  String newPath = path.substring(0, lastSeparator + 1) +
                                      title +
                                      _fileExtension;
